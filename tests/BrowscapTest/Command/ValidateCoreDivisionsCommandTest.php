...
use Browscap\Command\ValidateCoreDivisionsCommand;
...
class ValidateCoreDivisionsCommandTest extends TestCase
{
    /**
    ...
    public function testConstruct(): void
    {
        ...
        self::assertSame('validate-core-divisions', $object->getName());
