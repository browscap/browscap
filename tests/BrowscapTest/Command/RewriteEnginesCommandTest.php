...
use Browscap\Command\RewriteEnginesCommand;
...
class RewriteEnginesCommandTest extends TestCase
{
    /**
    ...
    public function testConstruct(): void
    {
        ...
        self::assertSame('rewrite-engines', $object->getName());
        self::assertSame('rewrites the resource files for the engines', $object->getDescription());
