...
use Browscap\Command\RewritePlatformsCommand;
...
class RewritePlatformsCommandTest extends TestCase
{
    /**
    ...
    public function testConstruct(): void
    {
        ...
        self::assertSame('rewrite-platforms', $object->getName());
        self::assertSame('rewrites the resource files for the platforms', $object->getDescription());
