...
use Browscap\Command\RewriteBrowsersCommand;
...
class RewriteBrowsersCommandTest extends TestCase
{
    /**
    ...
    public function testConstruct(): void
    {
        ...
        self::assertSame('rewrite-browsers', $object->getName());
        self::assertSame('rewrites the resource files for the browsers', $object->getDescription());
