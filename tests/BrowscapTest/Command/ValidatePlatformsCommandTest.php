...
use Browscap\Command\ValidatePlatformsCommand;
...
class ValidatePlatformsCommandTest extends TestCase
{
    /**
    ...
    public function testConstruct(): void
    {
        ...
        self::assertSame('validate-platforms', $object->getName());
        self::assertSame('validates the resource files for the platforms', $object->getDescription());
