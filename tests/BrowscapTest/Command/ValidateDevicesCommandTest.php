...
use Browscap\Command\ValidateDevicesCommand;
...
class ValidateDevicesCommandTest extends TestCase
{
    /**
    ...
    public function testConstruct(): void
    {
        ...
        self::assertSame('validate-devices', $object->getName());
        self::assertSame('validates the resource files for the devices', $object->getDescription());
